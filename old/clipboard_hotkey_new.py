...
import platform
import os
from PyQt5.QtWidgets import QApplication, QDialog, QVBoxLayout, QLabel, QTableWidget, QTableWidgetItem, QDesktopWidget
...
class FormatSelector(QDialog):
    ...
    def update_selection(self):
        # Clear all highlights and table selection
